...
const Module1Icon = ({ className }: { className?: string }): JSX.Element => (
...
const Module2Icon = ({ className }: { className?: string }): JSX.Element => (
...
const Module3Icon = ({ className }: { className?: string }): JSX.Element => (
...
const Module4Icon = ({ className }: { className?: string }): JSX.Element => (
...
const Module5Icon = ({ className }: { className?: string }): JSX.Element => (
...
const Module6Icon = ({ className }: { className?: string }): JSX.Element => (
